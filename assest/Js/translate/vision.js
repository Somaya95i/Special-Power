let ArData = {
  ...
  vision: {
    section__title: "الرؤية",
    mission__description:
      "إننـا شـركة نتطلـع دائمـا للمسـتقبل بتطويـر ذاتنـا والوصـول بأفضـل التطبيقـات الحديثـة والمتطـورة لتقديـم أفضــل مــا لدينــا وتحقيــق النجــاح المرجــو بخطــوات واضحــة ورؤيــة شــاملة وناجحــة بمــا يتوافــق مــع رؤيــة المملكــة ٢٠٣٠",
  },
};
...
function setLanguage(getLanguage) {
  if (getLanguage === "arabic") {
    ...
    // Vision
    section__title.innerHTML = ArData.vision.section__title;
    Mission__description.innerHTML = ArData.vision.mission__description;
    ...
    // Vision
    section__title.innerHTML = "The Our Vision";
    Mission__description.innerHTML =
      "“We are a company that always looks to the future by developing ourselves and providing the best modern and advanced applications to provide Our best and achieving the desired success with clear steps and a comprehensive and successful vision in line with the vision of Kingdom 2030.”";
